	...
	<nav class="border-b border-gray-800">
		<div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
			<ul class="flex flex-col md:flex-row items-center">
				...
				<li class="inline-block relative md:ml-16 mt-3 md:mt-0" x-data="{ isOpen: false }" @click.away.debounce.100ms="isOpen = false">
					<button 
						@mouseover.debounce.100ms="isOpen = true"
						@click.debounce.100ms="isOpen = !isOpen"
						{{-- @mouseout.debounce.500ms="isOpen = false" --}}
						class="block focus:outline-none">
						{{ __('Cinema & TV') }}
						{{-- <svg :class="{'rotate-180': isOpen}" class="transform inline-block fill-current w-6 h-6"><path fill-rule="evenodd" d="M15.3 10.3a1 1 0 011.4 1.4l-4 4a1 1 0 01-1.4 0l-4-4a1 1 0 011.4-1.4l3.3 3.29 3.3-3.3z"/></svg> --}}
					</button>
					<ul 
